...
export default function AdminLogin() {
  ...
  return (
    <div className="relative flex min-h-svh items-center justify-center overflow-hidden bg-pitch-950 px-4">
      ...
      <div className="pointer-events-none absolute -right-24 top-1/3 h-72 w-72 rounded-full bg-gold-400/10 blur-3xl" />
      ...
      <div className="relative w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="relative space-y-4 rounded-2xl border border-white/10 bg-white p-6 pt-9 shadow-2xl sm:p-8 sm:pt-10">
          <span className="absolute -top-5 left-1/2 flex h-10 w-10 -translate-x-1/2 items-center justify-center rounded-full bg-gold-500 text-pitch-950 shadow-lg ring-4 ring-pitch-950">
            <Settings size={18} />
          </span>
